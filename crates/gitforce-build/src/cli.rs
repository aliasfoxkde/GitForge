...
use gitforce_build::client::{JobSubmitter, UnixSocketClient, DEFAULT_SOCKET};
use gitforce_build::Response;
...
mod tests {
    use super::*;
    use gitforce_build::client::{JobSubmitter, MockClient};
    use gitforce_build::{JobInfo, Response};
